---
name: save-thread
description: "Create a structured handoff summary when the user asks for a checkpoint. OMP transcript sync is automatic; this skill adds a concise continuation record."
---

# Save Thread

The Nowledge Mem OMP plugin automatically syncs completed OMP conversations as searchable threads. This skill creates a structured handoff summary when the user wants a concise checkpoint for a future session.
