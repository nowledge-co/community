...
If Hermes is launched with `NMEM_SPACE="<space name>"`, treat that lane as the ambient default for Working Memory, search, save, and thread tools. Legacy `NMEM_SPACE_ID` still works for older setups.
