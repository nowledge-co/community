...
| **Grok Bot connector** | Add a custom MCP connector in Grok Bot settings | Grok Bot is cloud-hosted: use a public HTTPS Mem endpoint. It has no local plugin install or verified automatic full-thread capture. |
