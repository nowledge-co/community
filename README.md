...
| **[Cursor Plugin](nowledge-mem-cursor-plugin)** | Search `Nowledge Mem` in Cursor Marketplace | Cursor-native plugin package with a session-start Working Memory hook, bundled MCP config, rules, and honest `save-handoff` semantics. |
