...
| **[Codex Plugin](nowledge-mem-codex-plugin)** | Copy plugin to `~/.codex/plugins/nowledge-mem` | Native Codex plugin with five composable skills for Working Memory, routed recall, real session save, and distillation. |
