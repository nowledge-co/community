...
- **Plugin not loading.** Re-run `./scripts/install.sh`, confirm the root entry `${XDG_CONFIG_HOME:-$HOME/.config}/amp/plugins/nowledge-mem.ts` and the bundle beside it exist, and restart Amp.
