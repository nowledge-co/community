...
- Nine registered tools (`nowledge_mem_*`): Context Bundle, Working Memory, search, save, update, thread search, save thread, save handoff, status.
...
- Amp-native skill (`nowledge-mem`) carrying behavioral guidance, since Amp exposes no documented system-prompt injection hook.
