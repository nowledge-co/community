...
export function createContextTool(client, logger) {
	return {
		...
		description:
			"Read the user's Working Memory — today's focus areas, priorities, unresolved flags, and recent activity. " +
			"Generated by the Knowledge Agent each morning and updated throughout the day as new knowledge arrives. " +
			"Call this to understand what the user is currently focused on and what needs their attention. " +
			"Note: Working Memory is updated by the background Knowledge Agent. " +
