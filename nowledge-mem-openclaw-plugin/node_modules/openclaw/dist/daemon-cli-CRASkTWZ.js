...
import { i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshot, r as createConfigIO } from "./config-T-YRaqlE.js";
...
import { u as resolveGatewayBindHost } from "./net-BeVBFfmJ.js";
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-01ygwTnc.js";
import { a as resolveGatewayAuth } from "./auth-sHkz6y1W.js";
import { a as formatPortDiagnostics, i as classifyPortListener, n as inspectPortUsage } from "./ports-Cvvcdjes.js";
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-jLEtYiv7.js";
import { r as isWSLEnv } from "./wsl-DioJd74d.js";
import { t as formatDocsLink } from "./links-CeoK7yOD.js";
import { n as withProgress } from "./progress-GGN1XdxY.js";
import { g as resolveControlUiLinks, h as randomToken } from "./onboard-helpers-DbKs-NAe.js";
import { n as inheritOptionFromParent } from "./command-options-Cx6evn0x.js";
import { t as buildGatewayInstallPlan } from "./daemon-install-helpers-DKevQSuG.js";
...
const DEFAULT_RESTART_HEALTH_ATTEMPTS = 8;
const DEFAULT_RESTART_HEALTH_DELAY_MS = 450;
...
async function runDaemonRestart(opts = {}) {
	...
	return await runServiceRestart({
		...
		postRestartCheck: async ({ warnings, fail, stdout }) => {
			...
			} else warnings.push(...diagnostics);
			fail("Gateway restart failed health checks.", [formatCliCommand("openclaw gateway status --probe --deep"), formatCliCommand("openclaw doctor")]);
		}
	});
}
