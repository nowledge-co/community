...
import { C as updateAuthProfileStoreWithLock, Ct as resolveApiKeyForProvider, Gt as DEFAULT_PROVIDER, H as resolveConfiguredModelRef, Jt as CODEX_CLI_PROFILE_ID, P as getModelRefStatus, W as resolveHooksGmailModel, Wt as DEFAULT_MODEL, l as resolveApiKeyForProfile, m as repairOAuthProfileIdMismatch, qt as CLAUDE_CLI_PROFILE_ID, s as resolveProfileUnusableUntilForDisplay, x as ensureAuthProfileStore } from "./auth-profiles-B5C565zk.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CpnCVZWO.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-DseaG_X0.js";
import { c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, p as DEFAULT_AGENTS_FILENAME } from "./agent-scope-Vp6cG_dU.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BNEhWdVQ.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-T-YRaqlE.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BUD9fxqU.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-BeVBFfmJ.js";
import { bn as formatRemainingShort, g as loadOpenClawPlugins, vn as DEFAULT_OAUTH_WARN_MS, yn as buildAuthHealthSummary } from "./subagent-registry-C8AjcLWJ.js";
import { G as cleanStaleLockFiles, R as resolveMainSessionKey, s as loadSessionStore } from "./sessions-tFJJzGVL.js";
import { n as listChannelPlugins } from "./plugins-mjKPZoHW.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-DZoG3640.js";
import { a as resolveGatewayAuth } from "./auth-sHkz6y1W.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-Cvvcdjes.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CXIOqFsA.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-Dl01gtSM.js";
...
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-jLEtYiv7.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DioJd74d.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-DbKs-NAe.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-A8DAw4-S.js";
import { t as note$1 } from "./note-Di2CVd8s.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-3x6ZUz93.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-DKevQSuG.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Bx-u4xVC.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-C8J0px_u.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BLDuAGNF.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-CQvszb-i.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-gBXKmaH8.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DG8PK2e9.js";
import { r as healthCommand } from "./health-tb27M5Ss.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-C0olSs6k.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-CZ4WBsul.js";
import { t as resolveDmAllowState } from "./dm-policy-shared-pGa8zQCc.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CEMdexXv.js";
import { n as logConfigUpdated } from "./logging-COSqTUXs.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-Chhpi_J6.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BLB6vVOv.js";
import { t as formatHealthCheckFailure } from "./health-format-Qp_WoCiH.js";
import { n as doctorShellCompletion } from "./doctor-completion-DWKKVk88.js";
