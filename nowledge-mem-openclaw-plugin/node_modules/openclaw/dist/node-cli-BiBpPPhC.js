...
import { r as resolveAgentConfig } from "./agent-scope-Vp6cG_dU.js";
...
import { Y as analyzeArgvCommand, i as loadConfig } from "./config-T-YRaqlE.js";
import { r as VERSION } from "./env-vars-iFkEK4MO.js";
import { Xt as loadOrCreateDeviceIdentity, t as GatewayClient } from "./client-Dm_agh84.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-CeD-0oOz.js";
...
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName, t as withTimeout } from "./with-timeout-Do-sNSMI.js";
...
import { i as resolveBrowserConfig } from "./server-context-Cjmjlel5.js";
...
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-DEK2b59y.js";
import { n as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CvZXvVH0.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, d as resolveExecApprovals, l as recordAllowlistUse, m as requestJsonlSocket, n as addAllowlistEntry, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, u as requiresExecApproval } from "./exec-approvals-Cur0r_mD.js";
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-jLEtYiv7.js";
...
import { a as buildNodeServiceEnvironment, i as emitNodeRuntimeWarning, p as resolveNodeProgramArguments, r as resolveGatewayDevMode, u as resolvePreferredNodePath } from "./daemon-install-helpers-DKevQSuG.js";
import "./runtime-guard-DXZzkWDN.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Bx-u4xVC.js";
import "./systemd-C8J0px_u.js";
import { s as resolveGatewayLogPaths } from "./service-BLDuAGNF.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DzW5WH13.js";
import { s as formatRuntimeStatus } from "./systemd-hints-CQvszb-i.js";
import { t as parsePort } from "./parse-port-UrPKM547.js";
...
async function handleSystemRunInvoke(opts) {
	...
	const bins = autoAllowSkills ? await opts.skillBins.current() : /* @__PURE__ */ new Set();
	...
	const cmdInvocation = shellCommand ? opts.isCmdExeInvocation(segments[0]?.argv ?? []) : opts.isCmdExeInvocation(argv);
	...
	if (policy.approvalDecision === "allow-always" && security === "allowlist") {
		if (policy.analysisOk) {
			...
			for (const pattern of patterns) if (pattern) addAllowlistEntry(approvals.file, agentId, pattern);
		}
	}
	...
	let execArgv = argv;
	if (security === "allowlist" && isWindows && !policy.approvedByAsk && shellCommand && policy.analysisOk && policy.allowlistSatisfied && segments.length === 1 && segments[0]?.argv.length > 0) execArgv = segments[0].argv;
	const result = await opts.runCommand(execArgv, opts.params.cwd?.trim() || void 0, env, opts.params.timeoutMs ?? void 0);
	if (result.truncated) {
