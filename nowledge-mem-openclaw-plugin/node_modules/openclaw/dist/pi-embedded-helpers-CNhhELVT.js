...
import { L as resolveUserPath, W as truncateUtf16Safe, ct as resolvePreferredOpenClawTmpDir, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger } from "./subsystem-DNjXI6xf.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-CsUx6Yfs.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-DcKzlxc-.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-CtORg1Fr.js";
import { t as generateSecureToken } from "./secure-random-xpZo1jCG.js";
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-D3E0ptta.js";
import { a as writeConfigFile, n as loadConfig, t as createConfigIO } from "./config-Y4aFpi2A.js";
import { A as DEFAULT_BROWSER_EVALUATE_ENABLED, D as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, M as DEFAULT_OPENCLAW_BROWSER_ENABLED, N as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, O as DEFAULT_AI_SNAPSHOT_MAX_CHARS, S as stopChromeExtensionRelayServer, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_COLOR, k as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as isLoopbackHost, x as ensureChromeExtensionRelayServer } from "./chrome-Cp11xsGp.js";
import { t as SsrFBlockedError } from "./ssrf-D_av5wos.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Deq7jLXB.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Ch4QboNP.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-DCsfOq9h.js";
import { B as resolveAgentMainSessionKey, G as acquireSessionWriteLock, z as canonicalizeMainSessionAlias } from "./sessions-BH9VzbnR.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DqeXEfyj.js";
import { o as normalizeThinkLevel } from "./thinking-CLSwmd68.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C_G5ZQMZ.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C_G5ZQMZ.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { expandPolicyWithPluginGroups as $, isTimeoutErrorMessage as A, resolveBrowserConfig as B, isCompactionFailureError as C, isLikelyContextOverflowError as D, isFailoverErrorMessage as E, ensureSandboxWorkspaceForSession as F, ensureBrowserControlAuth as G, DEFAULT_UPLOAD_DIR as H, resolveSandboxContext as I, trimToUndefined as J, resolveBrowserControlAuth as K, resolveSandboxRuntimeStatus as L, parseImageDimensionError as M, parseImageSizeError as N, isRateLimitAssistantError as O, sanitizeUserFacingText as P, collectExplicitAllowlist as Q, createBrowserRouteContext as R, isCloudCodeAssistFormatError as S, isFailoverAssistantError as T, resolveExistingPathsWithinRoot as U, resolveProfile as V, getBridgeAuthForPort as W, applyOwnerOnlyToolPolicy as X, resolveSandboxConfigForAgent as Y, buildPluginToolGroups as Z, formatBillingErrorMessage as _, isMessagingToolDuplicateNormalized as a, compileGlobPatterns as at, isAuthAssistantError as b, extractToolCallsFromAssistant as c, ensureSessionHeader as ct, downgradeOpenAIReasoningBlocks as d, sanitizeGoogleTurnOrdering as dt, mergeAlsoAllowPolicy as et, isAntigravityClaude as f, formatAssistantErrorText as g, classifyFailoverReason as h, isMessagingToolDuplicate as i, resolveToolProfilePolicy as it, isTransientHttpError as j, isRawApiErrorPayload as k, extractToolResultId as l, resolveBootstrapMaxChars as lt, BILLING_ERROR_USER_MESSAGE as m, validateGeminiTurns as n, expandToolGroups as nt, normalizeTextForComparison as o, matchesAnyGlobPattern as ot, isGoogleModelApi as p, resolveGatewayCredentialsFromConfig as q, pickFallbackThinkingLevel as r, normalizeToolName as rt, sanitizeSessionMessagesImages as s, buildBootstrapContextFiles as st, validateAnthropicTurns as t, stripPluginOnlyAllowlist as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveBootstrapTotalMaxChars as ut, formatRawAssistantErrorForUi as v, isContextOverflowError as w, isBillingAssistantError as x, getApiErrorPayloadFingerprint as y, registerBrowserRoutes as z };