...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DbKs-NAe.js";
import { t as WizardCancelledError } from "./prompts-DbBg4o39.js";
import { t as createClackPrompter } from "./clack-prompter-WNNLlfYu.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DXZzkWDN.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Bx-u4xVC.js";
import { t as runOnboardingWizard } from "./onboarding-DWmZXqQz.js";
import { n as logConfigUpdated } from "./logging-COSqTUXs.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-D9UXJecp.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-CrA0WVN8.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B9VL0U0Z.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BAJZT8fX.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-tb27M5Ss.js").then((n) => n.i);
