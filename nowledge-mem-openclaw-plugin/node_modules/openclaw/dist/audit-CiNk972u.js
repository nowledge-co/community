...
import { s as normalizeAgentId } from "./session-key-DmcFQksq.js";
import { n as runExec } from "./exec-DseaG_X0.js";
import { l as resolveDefaultAgentId } from "./agent-scope-Vp6cG_dU.js";
import { a as MANIFEST_KEY, n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-DkMlwCU-.js";
import { i as loadWorkspaceSkillEntries } from "./skills-C_gUPQn1.js";
import { u as normalizePluginsConfig } from "./manifest-registry-CFtP_mkw.js";
import { bt as MAX_INCLUDE_DEPTH, r as createConfigIO, yt as INCLUDE_KEY } from "./config-T-YRaqlE.js";
import { l as normalizeStringEntries } from "./dock-G4cjJyIp.js";
import { t as GatewayClient } from "./client-Dm_agh84.js";
import { c as READ_SCOPE, t as buildGatewayConnectionDetails } from "./call-BUD9fxqU.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-CeD-0oOz.js";
import { t as resolveGatewayCredentialsFromConfig } from "./credentials-CzkHp5NQ.js";
import { n as listChannelPlugins } from "./plugins-mjKPZoHW.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-DZoG3640.js";
import { a as resolveGatewayAuth } from "./auth-sHkz6y1W.js";
import { a as resolveProfile, i as resolveBrowserConfig, m as resolveBrowserControlAuth } from "./server-context-Cjmjlel5.js";
import { n as formatErrorMessage } from "./errors-C0_m8FH_.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CvZXvVH0.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-CV3rSV1B.js";
...
import { n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-D74j9leo.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-BexBfR1i.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-Dc2kLx8o.js";
...
const DISCORD_ALLOWLIST_ID_PREFIXES = [
	"discord:",
	"user:",
	"pk:"
];
...
function addDiscordNameBasedEntries(params) {
	...
	for (const value of params.values) {
		if (!isDiscordNameBasedAllowEntry(value)) continue;
		...
		if (plugin.id === "discord") {
			...
			if (discordNameBasedAllowEntries.size > 0) {
				...
				findings.push({
					...
					detail: `Discord name/tag allowlist matching uses normalized slugs and can collide across users. Found: ${examples.join(", ")}${more}.`,
