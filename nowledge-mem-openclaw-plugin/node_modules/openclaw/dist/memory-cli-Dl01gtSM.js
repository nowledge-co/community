...
import { C as parseDurationMs, i as loadConfig, ut as splitShellArgs } from "./config-T-YRaqlE.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-CpEolL3Q.js";
import { t as formatDocsLink } from "./links-CeoK7yOD.js";
import { r as withManager } from "./cli-utils-DrfEy7kN.js";
import { t as formatHelpExamples } from "./help-format-D46DMScn.js";
import { n as withProgress, r as withProgressTotals } from "./progress-GGN1XdxY.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DmDK3aB8.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-C7k8M9TI.js").then((n) => n.t);
