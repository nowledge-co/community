...
import { Gt as DEFAULT_PROVIDER, H as resolveConfiguredModelRef, Ut as DEFAULT_CONTEXT_TOKENS, Wt as DEFAULT_MODEL } from "./auth-profiles-B5C565zk.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { C as parseAgentSessionKey } from "./session-key-DmcFQksq.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-CpnCVZWO.js";
import { n as runExec } from "./exec-DseaG_X0.js";
import { c as resolveAgentWorkspaceDir } from "./agent-scope-Vp6cG_dU.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BNEhWdVQ.js";
import { i as loadConfig, o as readConfigFileSnapshot } from "./config-T-YRaqlE.js";
...
import { Dn as peekSystemEvents, St as summarizeRestartSentinel, cn as buildChannelAccountSnapshot, in as formatUsageReportLines, ln as formatChannelAllowFrom, nt as sha256HexPrefix, rn as loadProviderUsageSummary, sn as buildChannelSummary, xt as readRestartSentinel } from "./subagent-registry-C8AjcLWJ.js";
import { P as resolveFreshSessionTotalTokens, R as resolveMainSessionKey, s as loadSessionStore } from "./sessions-tFJJzGVL.js";
import { n as listChannelPlugins } from "./plugins-mjKPZoHW.js";
import { o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-Df7MwSXG.js";
import { a as formatPortDiagnostics, n as inspectPortUsage } from "./ports-Cvvcdjes.js";
import { l as resolveStorePath } from "./paths-CXIOqFsA.js";
import { r as getMemorySearchManager } from "./memory-cli-Dl01gtSM.js";
import { n as formatTimeAgo } from "./format-relative-C0ydo41N.js";
import { d as lookupContextTokens, l as resolveSessionModelRef, n as classifySessionKey, r as listAgentsForGateway } from "./session-utils-G_glLiDN.js";
import { o as getRemoteSkillEligibility } from "./skill-commands-xvplpuxk.js";
import { r as formatDurationPrecise } from "./format-duration-DeLiQNNv.js";
import { n as withProgress } from "./progress-GGN1XdxY.js";
import { C as normalizeControlUiBasePath, g as resolveControlUiLinks } from "./onboard-helpers-DbKs-NAe.js";
...
import { s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-BLDuAGNF.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-CfJkpAfc.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-gBXKmaH8.js";
import { t as renderTable } from "./table-muj3Scnd.js";
import { l as probeGateway, o as resolveGatewayProbeAuth$1, t as runSecurityAudit } from "./audit-CiNk972u.js";
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-tb27M5Ss.js";
import { _ as resolveUpdateChannelDisplay, a as formatGitInstallLabel, h as normalizeUpdateChannel, n as checkUpdateStatus, t as resolveDefaultChannelAccountContext } from "./channel-account-context-CZ4WBsul.js";
import { t as resolveNodeService } from "./node-service-D-I_FGIb.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-DD_JpuRD.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-ZCkF20eu.js";
import { t as shortenText } from "./text-format-vm_tLd9u.js";
...
async function getStatusSummary(options = {}) {
	...
	const buildSessionRows = (store, opts = {}) => Object.entries(store).filter(([key]) => key !== "global" && key !== "unknown").map(([key, entry]) => {
		...
		const model = resolveSessionModelRef(cfg, entry, opts.agentIdOverride).model ?? configModel ?? null;
