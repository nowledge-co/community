import { $t as clearInternalHooks, At as getResolvedLoggerSettings, Bt as isNixMode, C as CHANNEL_IDS, Dt as theme, Et as isRich, F as createEmptyPluginRegistry, Gt as resolveGatewayLockDir, Ht as resolveConfigPath, Kt as resolveGatewayPort, Lt as CONFIG_PATH, M as getActivePluginRegistry, Ot as getChildLogger, Qt as resolveStateDir, Tt as colorize, U as CONFIG_DIR, W as clamp, Y as ensureDir, c as runtimeForLogger, d as setConsoleSubsystemFilter, en as createInternalHookEvent, f as setConsoleTimestampPrefix, hn as expandHomePrefix, i as logAcceptedEnvOption, kt as getLogger, lt as shortenHomePath, mt as isPlainObject, nn as triggerInternalHook, ot as resolveUserPath, pt as truncateUtf16Safe, r as isTruthyEnvValue, s as createSubsystemLogger, tn as registerInternalHook, v as defaultRuntime, xt as setVerbose, zt as STATE_DIR } from "./entry.js";
import { A as buildAllowedModelSet, B as resolveAllowedModelRef, F as isCliProvider, Gt as DEFAULT_PROVIDER, H as resolveConfiguredModelRef, Ot as normalizeSecretInput, P as getModelRefStatus, U as resolveDefaultModelForAgent, Ut as DEFAULT_CONTEXT_TOKENS, W as resolveHooksGmailModel, Wt as DEFAULT_MODEL, Y as resolveThinkingDefault, k as isPidAlive, q as resolveSubagentConfiguredModelSelection } from "./auth-profiles-B5C565zk.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { C as parseAgentSessionKey, S as isSubagentSessionKey, b as isCronRunSessionKey, c as normalizeMainKey, f as toAgentRequestSessionKey, h as normalizeAccountId, l as resolveAgentIdFromSessionKey, m as DEFAULT_ACCOUNT_ID, o as classifySessionKeyShape, p as toAgentStoreSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-DmcFQksq.js";
import { r as matchesSkillFilter, t as resolveOpenClawPackageRoot } from "./openclaw-root-CpnCVZWO.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-DseaG_X0.js";
import { C as ensureAgentWorkspace, D as resolveDefaultAgentWorkspaceDir, O as resolveWorkspaceTemplateDir, S as DEFAULT_USER_FILENAME, T as isWorkspaceOnboardingCompleted, _ as DEFAULT_IDENTITY_FILENAME, a as resolveAgentModelFallbacksOverride, b as DEFAULT_SOUL_FILENAME, c as resolveAgentWorkspaceDir, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, i as resolveAgentDir, l as resolveDefaultAgentId, n as listAgentIds, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, s as resolveAgentSkillsFilter, t as listAgentEntries, v as DEFAULT_MEMORY_ALT_FILENAME, x as DEFAULT_TOOLS_FILENAME, y as DEFAULT_MEMORY_FILENAME } from "./agent-scope-Vp6cG_dU.js";
...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-C_gUPQn1.js";
import { l as isTestDefaultMemorySlotDisabled } from "./manifest-registry-CFtP_mkw.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BNEhWdVQ.js";
import { C as parseDurationMs, Ct as resolveSubagentMaxConcurrent, D as isAvatarImageDataUrl, E as isAvatarHttpUrl, S as sensitive, St as resolveAgentMaxConcurrent, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, dt as applyMergePatch, ft as applyLegacyMigrations, i as loadConfig, j as looksLikeAvatarPath, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins, w as AVATAR_MAX_BYTES } from "./config-T-YRaqlE.js";
import { i as resolveRuntimeServiceVersion, r as VERSION } from "./env-vars-iFkEK4MO.js";
import "./dock-G4cjJyIp.js";
import { $ as validateNodePairRejectParams, A as validateCronStatusParams, At as ErrorCodes, B as validateExecApprovalsGetParams, Bt as removePairedDevice, C as validateConfigSetParams, Ct as validateWebLoginStartParams, D as validateCronRemoveParams, Dt as validateWizardStartParams, E as validateCronListParams, Et as validateWizardNextParams, F as validateDevicePairRemoveParams, Ft as approveDevicePairing, G as validateModelsListParams, Gt as updatePairedDeviceMetadata, H as validateExecApprovalsNodeSetParams, Ht as revokeDeviceToken, I as validateDeviceTokenRevokeParams, It as ensureDeviceToken, J as validateNodeInvokeParams, K as validateNodeDescribeParams, Kt as verifyDeviceToken, L as validateDeviceTokenRotateParams, Lt as getPairedDevice, M as validateDevicePairApproveParams, N as validateDevicePairListParams, Nt as parseSessionLabel, O as validateCronRunParams, Ot as validateWizardStatusParams, P as validateDevicePairRejectParams, Pt as buildDeviceAuthPayload, Q as validateNodePairListParams, Qt as verifyDeviceSignature, R as validateExecApprovalRequestParams, Rt as listDevicePairing, S as validateConfigSchemaParams, St as validateWakeParams, T as validateCronAddParams, Tt as validateWizardCancelParams, U as validateExecApprovalsSetParams, Ut as rotateDeviceToken, V as validateExecApprovalsNodeGetParams, Vt as requestDevicePairing, W as validateLogsTailParams, Wt as summarizeDeviceTokens, X as validateNodeListParams, Y as validateNodeInvokeResultParams, Yt as deriveDeviceIdFromPublicKey, Z as validateNodePairApproveParams, Zt as normalizeDevicePublicKeyBase64Url, _ as validateChatInjectParams, _t as validateSkillsStatusParams, a as validateAgentWaitParams, at as validateRequestFrame, b as validateConfigGetParams, bt as validateTalkModeParams, c as validateAgentsFilesGetParams, ct as validateSessionsDeleteParams, d as validateAgentsListParams, dt as validateSessionsPreviewParams, et as validateNodePairRequestParams, f as validateAgentsUpdateParams, ft as validateSessionsResetParams, g as validateChatHistoryParams, gt as validateSkillsInstallParams, h as validateChatAbortParams, ht as validateSkillsBinsParams, i as validateAgentParams, it as validatePushTestParams, j as validateCronUpdateParams, jt as errorShape, k as validateCronRunsParams, kt as PROTOCOL_VERSION, l as validateAgentsFilesListParams, lt as validateSessionsListParams, m as validateChannelsStatusParams, mt as validateSessionsUsageParams, n as formatValidationErrors, nt as validateNodeRenameParams, o as validateAgentsCreateParams, ot as validateSendParams, p as validateChannelsLogoutParams, pt as validateSessionsResolveParams, q as validateNodeEventParams, qt as roleScopesAllow, r as validateAgentIdentityParams, rt as validatePollParams, s as validateAgentsDeleteParams, st as validateSessionsCompactParams, tt as validateNodePairVerifyParams, u as validateAgentsFilesSetParams, ut as validateSessionsPatchParams, v as validateChatSendParams, vt as validateSkillsUpdateParams, w as validateConnectParams, wt as validateWebLoginWaitParams, x as validateConfigPatchParams, xt as validateUpdateRunParams, y as validateConfigApplyParams, yt as validateTalkConfigParams, z as validateExecApprovalResolveParams, zt as rejectDevicePairing } from "./client-Dm_agh84.js";
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-BUD9fxqU.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CeD-0oOz.js";
import { c as readJsonFile, l as writeJsonAtomic, s as createAsyncLock } from "./pairing-token-CNOCqkS5.js";
import { t as safeEqualSecret } from "./secret-equal-CNgVLV6x.js";
import { a as isTrustedProxyAddress, c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, l as resolveClientIp, n as isLoopbackAddress, o as isValidIPv4, p as rawDataToString, r as isLoopbackHost, s as normalizeHostHeader, t as isLocalishHost, u as resolveGatewayBindHost } from "./net-BeVBFfmJ.js";
import "./ip-CgUPLMdA.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-01ygwTnc.js";
import { i as normalizeInputProvenance } from "./input-provenance-Dp7sea2R.js";
import { $ as getCliSessionId, $n as resolveTtsApiKey, $t as setPreRestartDeferralCheck, A as resolveAgentAvatar, An as DEFAULT_INPUT_MAX_REDIRECTS, At as normalizeOptionalSessionKey, Bt as buildSafeExternalPrompt, C as agentCommand, Cn as parseVerboseOverride, Cr as getAgentRunContext, D as createOutboundSendDeps, Dt as normalizeCronJobPatch, E as resolveAgentOutboundTarget, Et as normalizeCronJobCreate, Fn as resolveInputFileLimits, Ft as buildDeliveryFromLegacyPayload, G as dispatchInboundMessage, Gn as isAbortTrigger, Gt as persistBrowserProxyFiles, Hn as formatZonedTimestamp, Ht as getHookType, It as hasLegacyDeliveryHints, Jt as emitGatewayRestart, K as createReplyDispatcher, Kn as stopSubagentsForRequester, Kt as consumeGatewaySigusr1RestartAuthorization, L as buildHistoryContextFromEntries, Ln as resolveAgentTimeoutMs, Lt as stripLegacyDeliveryFields, Mn as extractFileContentFromSource, Mt as normalizePayloadToSystemText, Nn as extractImageContentFromSource, Nt as normalizeRequiredName, O as createDefaultDeps, On as DEFAULT_INPUT_IMAGE_MAX_BYTES, Ot as inferLegacyName, Pn as normalizeMimeList, Pt as migrateLegacyCronPayload, Q as resolveCronStyleNow, Qn as isTtsProviderConfigured, Qt as setGatewaySigusr1RestartPolicy, S as sleepWithAbort, Sn as applyVerboseOverride, Sr as emitAgentEvent, St as summarizeRestartSentinel, T as resolveAgentDeliveryPlan, Tn as isSystemEventContextChanged, Tr as registerAgentRunContext, Tt as normalizeHttpWebhookUrl, Ut as isExternalHookSession, Vt as detectSuspiciousPatterns, Wt as applyBrowserProxyPaths, X as BARE_SESSION_RESET_PROMPT, Xn as getTtsProvider, Xt as markGatewaySigusr1RestartHandled, Yn as resolveUserTimezone, Yt as isGatewaySigusr1RestartExternallyAllowed, Zn as isTtsEnabled, Zt as scheduleGatewaySigusr1Restart, a as runSubagentAnnounceFlow, ar as setTtsProvider, at as resolveAnnounceTargetFromKey, b as requestBodyErrorToText, br as stripHeartbeatToken, bt as formatRestartSentinelMessage, c as abortEmbeddedPiRun, cr as OPENAI_TTS_VOICES, ct as resolveOutboundSessionRoute, d as applyToolPolicyPipeline, dn as requestHeartbeatNow, dr as getTotalQueueSize, dt as resolveOutboundTarget, en as unbindThreadBindingsBySessionKey, er as resolveTtsAutoMode, et as setCliSessionId, f as buildDefaultToolPolicyPipelineSteps, fr as resetAllLanes, ft as resolveSessionDeliveryTarget, g as loadOpenClawPlugins, gn as resolveSessionAuthProfileOverride, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, gt as runWithModelFallback, hn as resolveSendPolicy, hr as CommandLane, ir as setTtsEnabled, it as readLatestAssistantReply, jn as DEFAULT_INPUT_TIMEOUT_MS, jt as normalizeOptionalText, k as createOutboundSendDeps$1, kn as DEFAULT_INPUT_IMAGE_MIMES, kt as normalizeOptionalAgentId, l as getActiveEmbeddedRunCount, lr as getActiveTaskCount, m as getPluginToolMeta, mn as normalizeSendPolicy, mr as waitForActiveTasks, mt as resetDirectoryCache, n as initSubagentRegistry, nr as resolveTtsPrefsPath, o as clearSessionQueues, or as textToSpeech, pr as setCommandLaneConcurrency, q as getTotalPendingReplies, qt as deferGatewayRestartUntilIdle, r as listDescendantRunsForRequester, rn as loadProviderUsageSummary, rr as resolveTtsProviderOrder, rt as createOpenClawTools, s as runEmbeddedPiAgent, sr as OPENAI_TTS_MODELS, st as ensureOutboundSessionEntry, t as countActiveDescendantRuns, tn as normalizeGroupActivation, tr as resolveTtsConfig, tt as runCliAgent, u as waitForEmbeddedPiRunEnd, v as handleSlackHttpRequest, vt as consumeRestartSentinel, wn as enqueueSystemEvent, wr as onAgentEvent, wt as writeRestartSentinel, x as computeBackoff, xn as applyModelOverrideToSessionEntry, xr as clearAgentRunContext, y as readJsonBodyWithLimit, yt as formatDoctorNonInteractiveHint } from "./subagent-registry-C8AjcLWJ.js";
import { A as resolveSessionResetPolicy, C as stripEnvelopeFromMessages, E as stripInlineDirectiveTagsFromMessageForDisplay, F as canonicalizeMainSessionAlias, G as cleanStaleLockFiles, I as resolveAgentMainSessionKey, L as resolveExplicitAgentSessionKey, O as evaluateSessionFreshness, R as resolveMainSessionKey, S as resolveSessionTranscriptCandidates, T as stripInlineDirectiveTagsForDisplay, V as snapshotSessionOrigin, Y as mergeDeliveryContext, Z as normalizeSessionDeliveryFields, _ as archiveSessionTranscripts, b as readSessionPreviewItemsFromTranscript, f as updateSessionStore, g as archiveFileOnDisk, n as extractDeliveryInfo, q as deliveryContextFromSession, r as parseSessionThreadInfo, s as loadSessionStore, v as capArrayByJsonBytes, y as readSessionMessages, z as resolveMainSessionKeyFromConfig } from "./sessions-tFJJzGVL.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-CEQAF_FI.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-mjKPZoHW.js";
import { n as resolveWhatsAppAccount } from "./accounts-9Hm97-7-.js";
import { t as buildChannelAccountBindings } from "./bindings-DRU6YmSj.js";
import "./logging-CyKaqCo_.js";
import "./send-BHEev7wk.js";
import "./send--d3jcPxC.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-Do-sNSMI.js";
import { C as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, x as getGlobalHookRunner } from "./deliver-jUnlfpcd.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-DRlvPSiu.js";
import "./diagnostic-session-state-DLuYVc4W.js";
import "./accounts-DKuYlR6W.js";
import "./send-DVX_zY9w.js";
import { c as detectMime } from "./image-ops-ED4c3lgi.js";
import "./pi-embedded-helpers-B7rXYPuB.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-DZoG3640.js";
import "./chrome-CwpCHQXf.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Df7MwSXG.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-sHkz6y1W.js";
import { g as mergeGatewayTailscaleConfig, h as ensureGatewayStartupAuth } from "./server-context-Cjmjlel5.js";
import "./routes-FGJF5gtZ.js";
import "./redact-iUwTNBtX.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-C0_m8FH_.js";
import { n as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-CUG9oKdA.js";
import "./paths-B48NVbYC.js";
import { t as SsrFBlockedError } from "./ssrf-BUmMCCrH.js";
import "./store-DQdilc66.js";
import { a as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Cvvcdjes.js";
import { t as movePathToTrash } from "./trash-BZfBjeIy.js";
import "./accounts-nOtv8L5i.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CXIOqFsA.js";
import "./chat-envelope-B0TExquy.js";
import "./tool-images-C_OQRH5z.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-CEjvYsJw.js";
...
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-Cjty59Ak.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-Dl01gtSM.js";
import { n as resolveMemorySearchConfig } from "./manager-C7k8M9TI.js";
import "./gemini-auth-D3SYOg-4.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-C8RfPptD.js";
import "./query-expansion-CpEolL3Q.js";
import "./retry-CYfnOIlD.js";
import { a as ToolInputError } from "./target-errors-w0QNSkru.js";
...
import { r as isRestartEnabled } from "./commands-CV3rSV1B.js";
import "./commands-registry-qeJ2eG3c.js";
import "./image-CRv24xgn.js";
import "./tool-display-DdinKh-X.js";
import { d as registerUnhandledRejectionHandler } from "./runner-C6YJTH6y.js";
import { n as loadModelCatalog } from "./model-catalog-Dw64TluO.js";
...
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-xvplpuxk.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DOBMfIc3.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-CynYTGfO.js";
import "./fetch-_VotajCU.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Cur0r_mD.js";
import "./nodes-screen-BK5cXYr2.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-CsX3XzNA.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-CKspHcUl.js";
import { t as getChannelActivity } from "./channel-activity-DdH9i1uh.js";
import { n as normalizePollInput } from "./polls-C5zCULbA.js";
import "./tables-DSqC3itu.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-qfQQoBYf.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BJGKxryR.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-SYzHCfvA.js";
...
import { n as withProgress } from "./progress-GGN1XdxY.js";
import "./replies-UOjPvhgz.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-DbKs-NAe.js";
import "./prompt-style-A8DAw4-S.js";
import "./pairing-labels-WalmCKjT.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-D74j9leo.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-MirVQoXP.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-_hyEyMcT.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CdTnu3m4.js";
import { n as inheritOptionFromParent } from "./command-options-Cx6evn0x.js";
import { t as buildChannelUiCatalog } from "./catalog-Csdt88Yh.js";
import { t as WizardCancelledError } from "./prompts-DbBg4o39.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-CVfs7hut.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DqtMi0yW.js";
import { t as isWithinDir } from "./path-safety-DT7vAWNa.js";
import "./install-safe-path-Ba_l6HgK.js";
import "./skill-scanner-BexBfR1i.js";
import { t as buildChannelAccountSnapshot } from "./status-BVTsuvCS.js";
import "./channels-status-issues-3x6ZUz93.js";
import "./daemon-install-helpers-DKevQSuG.js";
import "./runtime-guard-DXZzkWDN.js";
import "./systemd-C8J0px_u.js";
import "./service-BLDuAGNF.js";
import "./lifecycle-core-DzW5WH13.js";
import "./systemd-hints-CQvszb-i.js";
import { t as parsePort$1 } from "./parse-port-UrPKM547.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-CRASkTWZ.js";
import "./diagnostics-gBXKmaH8.js";
import "./table-muj3Scnd.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BWEMaQQX.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-01k4KTM8.js";
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-CiNk972u.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-mxst6zpq.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-DU8tDKsE.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-tb27M5Ss.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-C0olSs6k.js";
import { h as normalizeUpdateChannel, l as DEFAULT_PACKAGE_CHANNEL, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-CZ4WBsul.js";
import { t as runOnboardingWizard } from "./onboarding-DWmZXqQz.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CYny7tzJ.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-4tKpjC5Q.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B5DABfpi.js";
import "./dm-policy-shared-pGa8zQCc.js";
import "./node-service-D-I_FGIb.js";
import "./status.update-ZCkF20eu.js";
import { t as resolveSystemRunCommand } from "./system-run-command-BVwA1y01.js";
import { t as installSkill } from "./skills-install-B9JsFOVo.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-CEMdexXv.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-Cy2Nb9dH.js";
import { n as forceFreePortAndWait } from "./ports-DsNBwU0y.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DRy1sBVy.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-CsX3XzNA.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-qfQQoBYf.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-C4Eb0w7a.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-jUnlfpcd.js").then((n) => n.n);
