import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-D8LJ4ibn.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-DVWx7USN.js";
import { B as resolveUserPath, c as CHANNEL_IDS, ft as resolvePreferredOpenClawTmpDir, i as defaultRuntime, q as truncateUtf16Safe, t as createSubsystemLogger } from "./subsystem-B3gKmYuz.js";
import { a as writeConfigFile, n as loadConfig, t as createConfigIO } from "./config-D7yhe8WC.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-Ck33m20r.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-DeS5VuCp.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-1rgxcvGb.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-CZuX7Z1C.js";
import { t as SsrFBlockedError } from "./ssrf-DswcqIq6.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-D8grjE7E.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Gt9vbHJR.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as isLoopbackHost, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, x as ensureChromeExtensionRelayServer } from "./chrome-B6OIe2xL.js";
import { A as acquireSessionWriteLock, B as canonicalizeMainSessionAlias, V as resolveAgentMainSessionKey } from "./sessions-Kufe0AiW.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-CXYl4NNL.js";
import { o as normalizeThinkLevel } from "./thinking-DFs8hJTB.js";
import { t as generateSecureToken } from "./secure-random-DeU7GZGs.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-C5r_MRes.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-C5r_MRes.js")).closePlaywrightBrowserConnection();
		} catch {}
...
async function ensureDockerNetwork(network) {
	...
	if (!normalized || normalized === "bridge" || normalized === "none" || normalized.startsWith("container:")) return;
	if ((await execDocker([
		"network",
		"inspect",
		network
...
//#endregion
export { stripPluginOnlyAllowlist as $, isTimeoutErrorMessage as A, resolveBrowserConfig as B, isCompactionFailureError as C, isLikelyContextOverflowError as D, isFailoverErrorMessage as E, ensureSandboxWorkspaceForSession as F, ensureBrowserControlAuth as G, DEFAULT_UPLOAD_DIR as H, resolveSandboxContext as I, applyOwnerOnlyToolPolicy as J, resolveBrowserControlAuth as K, resolveSandboxRuntimeStatus as L, parseImageDimensionError as M, parseImageSizeError as N, isRateLimitAssistantError as O, sanitizeUserFacingText as P, mergeAlsoAllowPolicy as Q, createBrowserRouteContext as R, isCloudCodeAssistFormatError as S, isFailoverAssistantError as T, resolveExistingPathsWithinRoot as U, resolveProfile as V, getBridgeAuthForPort as W, collectExplicitAllowlist as X, buildPluginToolGroups as Y, expandPolicyWithPluginGroups as Z, formatBillingErrorMessage as _, isMessagingToolDuplicateNormalized as a, buildBootstrapContextFiles as at, isAuthAssistantError as b, extractToolCallsFromAssistant as c, resolveBootstrapTotalMaxChars as ct, downgradeOpenAIReasoningBlocks as d, trimToUndefined as dt, expandToolGroups as et, isAntigravityClaude as f, formatAssistantErrorText as g, classifyFailoverReason as h, isMessagingToolDuplicate as i, matchesAnyGlobPattern as it, isTransientHttpError as j, isRawApiErrorPayload as k, extractToolResultId as l, sanitizeGoogleTurnOrdering as lt, BILLING_ERROR_USER_MESSAGE as m, validateGeminiTurns as n, resolveToolProfilePolicy as nt, normalizeTextForComparison as o, ensureSessionHeader as ot, isGoogleModelApi as p, resolveSandboxConfigForAgent as q, pickFallbackThinkingLevel as r, compileGlobPatterns as rt, sanitizeSessionMessagesImages as s, resolveBootstrapMaxChars as st, validateAnthropicTurns as t, normalizeToolName as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveGatewayCredentialsFromConfig as ut, formatRawAssistantErrorForUi as v, isContextOverflowError as w, isBillingAssistantError as x, getApiErrorPayloadFingerprint as y, registerBrowserRoutes as z };