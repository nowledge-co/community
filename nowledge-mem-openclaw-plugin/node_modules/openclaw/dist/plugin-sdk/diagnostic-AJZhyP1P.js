...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-xHsxBcGz.js";
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-CyjpmU1a.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
