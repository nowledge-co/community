import { a as buildGroupHistoryKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, s as normalizeAgentId } from "./session-key-D8LJ4ibn.js";
import { f as readWebSelfId, o as getWebAuthAgeMs, r as resolveWhatsAppAccount } from "./accounts-D-nCmJLC.js";
import { E as enqueueSystemEvent, G as resolveMentionGating, St as resolveOpenProviderRuntimeGroupPolicy, W as shouldAckReactionForWhatsApp, X as buildHistoryContextFromEntries, Y as DEFAULT_GROUP_HISTORY_LIMIT, _ as resolveEnvelopeFormatOptions, c as computeBackoff, d as formatDurationPrecise, f as dispatchReplyWithBufferedBlockDispatcher, g as formatInboundEnvelope, h as resolveInboundDebounceMs, it as normalizeMentionText, l as sleepWithAbort, m as createInboundDebouncer, n as normalizeGroupActivation, nt as recordPendingHistoryEntryIfEnabled, pt as createDedupeCache, r as parseActivationCommand, rt as buildMentionRegexes, t as getReplyFromConfig, u as buildPairingReply, v as hasControlCommand, wt as warnMissingProviderGroupPolicyFallbackOnce, xt as resolveDefaultGroupPolicy, y as shouldComputeCommandAuthorized } from "./reply-K0V5vcRO.js";
import { D as clamp, F as jidToE164, I as normalizeE164, K as toWhatsappJid, P as isSelfChatMode, W as sleep, Z as logVerbose, et as shouldLogVerbose, i as defaultRuntime, ot as getChildLogger, p as normalizeChatChannelId, t as createSubsystemLogger, z as resolveJidToE164 } from "./subsystem-B3gKmYuz.js";
import { n as loadConfig } from "./config-D7yhe8WC.js";
import { t as formatCliCommand } from "./command-format-Ck33m20r.js";
import { T as resolveChannelGroupRequireMention, w as resolveChannelGroupPolicy } from "./dock-B-ZHp6hI.js";
import { n as recordChannelActivity } from "./channel-activity-C0HQL-Ao.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-g06aP0A4.js";
import { a as loadWebMedia } from "./ir-D8Kvtoe3.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode, l as resolveTextChunkLimit } from "./chunk-Ds3oYomW.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-fj-uTU4P.js";
import { t as convertMarkdownTables } from "./tables-D9ws6oLu.js";
import { Q as upsertChannelPairingRequest, X as readChannelAllowFromStoreSync, Y as readChannelAllowFromStore, nt as toLocationContext, tt as formatLocationText } from "./send-znTQy4eS.js";
import { f as registerUnhandledRejectionHandler } from "./runner-CrEoy4qC.js";
import { l as resolveIdentityNamePrefix, n as createReplyPrefixOptions, u as resolveMessagePrefix } from "./reply-prefix-Dznj6LTI.js";
import { G as resolveGroupSessionKey, c as readSessionUpdatedAt, l as recordSessionMetaFromInbound, s as loadSessionStore, u as updateLastRoute } from "./sessions-Kufe0AiW.js";
import { l as resolveStorePath } from "./paths-KtBBYvS4.js";
import { i as saveMediaBuffer } from "./store-CXYl4NNL.js";
import { t as finalizeInboundContext } from "./inbound-context-C3RpmzGw.js";
import { n as resolveAgentRoute, t as buildAgentSessionKey } from "./resolve-route-DCVfVBNE.js";
import { r as setActiveWebListener } from "./active-listener-BAnk_nXh.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-C0QEbNER.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DULidOZf.js";
