...
import { Z as logVerbose, et as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-B3gKmYuz.js";
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-D7yhe8WC.js";
import { E as resolveApiKeyForProvider, H as resolveOpenClawAgentDir, T as requireApiKey, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-Be0rkSSc.js";
import { E as runExec } from "./agent-scope-DeS5VuCp.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CZuX7Z1C.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DDo5yfUq.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-g06aP0A4.js";
import { t as normalizeChatType } from "./chat-type-CfYBRycO.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-DvMwSfaa.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DtqAmYo3.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CLdAHc9I.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-WFOHrSAQ.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
