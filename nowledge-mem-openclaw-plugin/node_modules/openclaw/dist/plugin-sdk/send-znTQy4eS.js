...
import { a as resolveOAuthDir, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-DVWx7USN.js";
import { S as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-B5m5N2-_.js";
import { t as resolveFetch } from "./fetch-b2Zm8y7X.js";
import { V as safeParseJson, Y as danger, Z as logVerbose, t as createSubsystemLogger } from "./subsystem-B3gKmYuz.js";
import { Tt as resolveTelegramPreviewStreamMode, n as loadConfig } from "./config-D7yhe8WC.js";
import { r as isTruthyEnvValue } from "./command-format-Ck33m20r.js";
import { W as withFileLock$1 } from "./model-selection-Be0rkSSc.js";
import { t as redactSensitiveText } from "./redact-4KGGYfvj.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-1rgxcvGb.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-C0HQL-Ao.js";
import { n as normalizePollInput } from "./polls-3WJMd-G-.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-CZuX7Z1C.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-D8Kvtoe3.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-fj-uTU4P.js";
import { t as renderMarkdownWithMarkers } from "./render-C815sn1u.js";
import { t as makeProxyFetch } from "./proxy-LN4R-K_y.js";
...
async function createForumTopicTelegram(chatId, name, opts = {}) {
	...
	const token = resolveToken(opts.token, account);
	const normalizedChatId = normalizeChatId(parseTelegramTarget(chatId).chatId);
	const client = resolveTelegramClientOptions(account);
...
//#endregion
export { getPairingAdapter as $, hasBotMention as A, resolveSenderAllowMatch as B, buildTelegramGroupPeerId as C, describeReplyTarget as D, buildTypingThreadParams as E, resolveTelegramReplyId as F, isVoiceCompatibleAudio as G, isSenderIdAllowed as H, resolveTelegramStreamMode as I, addChannelAllowFromStoreEntry as J, parseTelegramTarget as K, resolveTelegramThreadSpec as L, resolveTelegramForumThreadId as M, resolveTelegramGroupAllowFromContext as N, expandTextLinks as O, resolveTelegramMediaPlaceholder as P, upsertChannelPairingRequest as Q, isSenderAllowed as R, buildTelegramGroupFrom as S, buildTelegramThreadParams as T, mergeAllowFromSources as U, firstDefined as V, withTelegramApiErrorLogging as W, readChannelAllowFromStoreSync as X, readChannelAllowFromStore as Y, removeChannelAllowFromStoreEntry as Z, resolveTelegramFetch as _, reactMessageTelegram as a, isWSLSync as at, buildSenderLabel as b, sendStickerTelegram as c, wasSentByBot as d, listPairingChannels as et, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, isWSLEnv as it, normalizeForwardedContext as j, extractTelegramLocation as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, toLocationContext as nt, sendMessageTelegram as o, readJsonFileWithFallback as ot, markdownToTelegramChunks as p, resolveTelegramTargetChatType as q, deleteMessageTelegram as r, isWSL2Sync as rt, sendPollTelegram as s, writeJsonFileAtomically as st, buildInlineKeyboard as t, formatLocationText as tt, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramParentPeer as w, buildSenderName as x, buildGroupLabel as y, normalizeAllowFromWithStore as z };