...
import { Lt as resolveOpenClawAgentDir } from "./model-selection-jLPRV2hp.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-yM0LKfPE.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
