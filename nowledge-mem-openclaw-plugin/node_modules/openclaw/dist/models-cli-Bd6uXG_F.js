...
import { B as theme, R as colorize, S as shortenHomePath, z as isRich$1 } from "./utils-DCtXtPui.js";
import "./thinking-EAliFiVK.js";
import { Ct as formatUsageWindowSummary, Yt as describeFailoverError, _r as DEFAULT_OAUTH_WARN_MS, gr as maskApiKey, l as runEmbeddedPiAgent, vr as buildAuthHealthSummary, wt as resolveUsageProviderId, xt as loadProviderUsageSummary, yr as formatRemainingShort } from "./reply-IQbtp7d2.js";
import { f as defaultRuntime } from "./subsystem-CYc2uK4P.js";
import "./exec-QOib7mc9.js";
import { D as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelFallbacksOverride, c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, o as resolveAgentModelPrimary } from "./agent-scope-CJ4YDowp.js";
import { At as upsertAuthProfile, Dt as listProfilesForProvider, It as resolveAuthStorePathForDisplay, J as resolveApiKeyForProvider, Jt as DEFAULT_PROVIDER, K as getCustomProviderApiKey, Lt as resolveOpenClawAgentDir, Mt as ensureAuthProfileStore, Q as getShellEnvAppliedKeys, Ut as resolveAuthProfileDisplayLabel, X as resolveEnvApiKey, Y as resolveAwsSdkEnvVarName, g as resolveModelRefFromString, i as findNormalizedProviderValue, kt as setAuthProfileOrder, l as normalizeProviderId, m as resolveDefaultModelForAgent, p as resolveConfiguredModelRef, pt as resolveAuthProfileOrder, qt as DEFAULT_MODEL, r as buildModelAliasIndex, rt as shouldEnableShellEnvFallback, s as modelKey, u as parseModelRef, vt as resolveProfileUnusableUntilForDisplay } from "./model-selection-jLPRV2hp.js";
...
import { C as parseDurationMs, i as loadConfig } from "./config-D9td3nQ8.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-B2VsCrQB.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CIwUV7XC.js";
...
import { a as resolveForwardCompatModel, i as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES, r as ANTIGRAVITY_GEMINI_31_FORWARD_COMPAT_CANDIDATES } from "./model-D8oSNHP2.js";
...
import "./help-format-D28_gnAS.js";
import { r as withProgressTotals } from "./progress-ebTx2ghO.js";
...
import { t as createClackPrompter } from "./clack-prompter-BW4jch76.js";
import { t as renderTable } from "./table-CZ7i53VY.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BcBQ11Vu.js";
import { n as redactSecrets } from "./format-CZG14xdV.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-_xTyqikX.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Dsff1U6O.js";
...
import { t as ensurePiAuthJsonFromAuthProfiles } from "./system-cli-D31Ji6iD.js";
...
async function loadModelRegistry(cfg) {
	...
	try {
		...
		for (const synthesized of synthesizedForwardCompat) if (hasAvailableTemplate(availableKeys, synthesized.templatePrefixes)) {
			availableKeys.add(synthesized.key);
			for (const aliasKey of synthesized.availabilityAliasKeys) availableKeys.add(aliasKey);
		}
	} catch (err) {
...
function appendAntigravityForwardCompatModels(models, modelRegistry) {
	...
	for (const candidate of candidates) {
		...
		synthesizedForwardCompat.push({
			...
			availabilityAliasKeys: candidate.availabilityAliasIds.map((id) => modelKey("google-antigravity", id))
		});
	}
	return {
		models: nextModels,
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-D9td3nQ8.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-jLPRV2hp.js").then((n) => n.ft);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-D8oSNHP2.js").then((n) => n.t);
