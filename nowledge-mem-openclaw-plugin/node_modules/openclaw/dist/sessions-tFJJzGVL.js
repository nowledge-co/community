...
import { O as resolveProcessScopedMap, k as isPidAlive } from "./auth-profiles-B5C565zk.js";
import { c as normalizeMainKey, g as normalizeOptionalAccountId, l as resolveAgentIdFromSessionKey, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-DmcFQksq.js";
import { C as parseDurationMs, f as parseByteSize, i as loadConfig } from "./config-T-YRaqlE.js";
import { c as normalizeHyphenSlug, t as getChannelDock } from "./dock-G4cjJyIp.js";
import { c as listDeliverableMessageChannels, l as normalizeMessageChannel } from "./message-channel-CeD-0oOz.js";
import { r as hasInterSessionUserProvenance } from "./input-provenance-Dp7sea2R.js";
import { r as normalizeChannelId } from "./plugins-mjKPZoHW.js";
import { t as normalizeChatType } from "./chat-type-C4Hly5GT.js";
import { n as resolveConversationLabel } from "./conversation-label-D7GczlG1.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, n as resolveDefaultSessionStorePath, o as resolveSessionTranscriptPathInDir, r as resolveSessionFilePath, s as resolveSessionTranscriptsDir, t as SAFE_SESSION_ID_RE, u as validateSessionId } from "./paths-CXIOqFsA.js";
import { n as stripMessageIdHints, o as extractToolCallNames, r as stripInboundMetadata, s as hasToolCall, t as stripEnvelope } from "./chat-envelope-B0TExquy.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-MbwoXAqo.js";
...
async function saveSessionStoreUnlocked(storePath, store, opts) {
	...
	if (!opts?.skipMaintenance) {
		...
		if (maintenance.mode === "warn") {
			...
			const prunedSessionFiles = /* @__PURE__ */ new Map();
			pruneStaleEntries(store, maintenance.pruneAfterMs, { onPruned: ({ entry }) => {
				if (!prunedSessionFiles.has(entry.sessionId) || entry.sessionFile) prunedSessionFiles.set(entry.sessionId, entry.sessionFile);
			} });
...
//#endregion
export { resolveSessionResetPolicy as A, deriveSessionMetaPatch as B, stripEnvelopeFromMessages as C, resolveSessionKey as D, stripInlineDirectiveTagsFromMessageForDisplay as E, canonicalizeMainSessionAlias as F, cleanStaleLockFiles as G, buildGroupDisplayName as H, resolveAgentMainSessionKey as I, deliveryContextKey as J, resolveSessionLockMaxHoldFromTimeout as K, resolveExplicitAgentSessionKey as L, resolveThreadFlag as M, DEFAULT_RESET_TRIGGERS as N, evaluateSessionFreshness as O, resolveFreshSessionTotalTokens as P, normalizeAccountId as Q, resolveMainSessionKey as R, resolveSessionTranscriptCandidates as S, stripInlineDirectiveTagsForDisplay as T, resolveGroupSessionKey as U, snapshotSessionOrigin as V, acquireSessionWriteLock as W, normalizeDeliveryContext as X, mergeDeliveryContext as Y, normalizeSessionDeliveryFields as Z, archiveSessionTranscripts as _, resolveMirroredTranscriptText as a, readSessionPreviewItemsFromTranscript as b, readSessionUpdatedAt as c, updateLastRoute as d, updateSessionStore as f, archiveFileOnDisk as g, resolveCacheTtlMs as h, appendAssistantMessageToSessionTranscript as i, resolveSessionResetType as j, resolveChannelResetConfig as k, recordSessionMetaFromInbound as l, isCacheEnabled as m, extractDeliveryInfo as n, resolveAndPersistSessionFile as o, updateSessionStoreEntry as p, deliveryContextFromSession as q, parseSessionThreadInfo as r, loadSessionStore as s, sessions_exports as t, saveSessionStore as u, capArrayByJsonBytes as v, parseInlineDirectives as w, readSessionTitleFieldsFromTranscript as x, readSessionMessages as y, resolveMainSessionKeyFromConfig as z };