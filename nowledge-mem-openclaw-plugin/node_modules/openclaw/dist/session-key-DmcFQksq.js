...
function normalizeOptionalAccountId(value) {
	const trimmed = (value ?? "").trim();
	if (!trimmed) return;
	return canonicalizeAccountId(trimmed) || void 0;
}
...
//#endregion
export { parseAgentSessionKey as C, isSubagentSessionKey as S, deriveSessionChatType as _, buildGroupHistoryKey as a, isCronRunSessionKey as b, normalizeMainKey as c, sanitizeAgentId as d, toAgentRequestSessionKey as f, normalizeOptionalAccountId as g, normalizeAccountId as h, buildAgentPeerSessionKey as i, resolveAgentIdFromSessionKey as l, DEFAULT_ACCOUNT_ID as m, DEFAULT_MAIN_KEY as n, classifySessionKeyShape as o, toAgentStoreSessionKey as p, buildAgentMainSessionKey as r, normalizeAgentId as s, DEFAULT_AGENT_ID as t, resolveThreadSessionKeys as u, getSubagentDepth as v, resolveThreadParentSessionKey as w, isCronSessionKey as x, isAcpSessionKey as y };