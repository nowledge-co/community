import { C as CONFIG_DIR, t as createSubsystemLogger } from "./subsystem-NZzGD1xL.js";
import { n as loadConfig } from "./config-Co-5D6Gn.js";
import { a as resolvePinnedHostnameWithPolicy, s as isLoopbackIpAddress } from "./ssrf-DoQDLHSj.js";
import { i as isErrno } from "./errors-xxnHvoWf.js";
...
function resolveRelayAuthTokenForPort(port) {
	...
	if (gatewayToken) return deriveRelayAuthToken(gatewayToken, port);
...
//#endregion
export { DEFAULT_BROWSER_EVALUATE_ENABLED as A, rawDataToString as C, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as D, DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH as E, DEFAULT_OPENCLAW_BROWSER_ENABLED as M, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as N, DEFAULT_AI_SNAPSHOT_MAX_CHARS as O, stopChromeExtensionRelayServer as S, isSecureWebSocketUrl as T, fetchJson as _, resolveOpenClawUserDataDir as a, withCdpSocket as b, captureScreenshot as c, normalizeCdpWsUrl as d, snapshotAria as f, appendCdpPath as g, withBrowserNavigationPolicy as h, launchOpenClawChrome as i, DEFAULT_OPENCLAW_BROWSER_COLOR as j, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as k, createTargetViaCdp as l, assertBrowserNavigationAllowed as m, isChromeCdpReady as n, stopOpenClawChrome as o, InvalidBrowserNavigationUrlError as p, isChromeReachable as r, resolveBrowserExecutableForPlatform as s, getChromeWebSocketUrl as t, formatAriaSnapshot as u, fetchOk as v, isLoopbackHost as w, ensureChromeExtensionRelayServer as x, getHeadersWithAuth as y };