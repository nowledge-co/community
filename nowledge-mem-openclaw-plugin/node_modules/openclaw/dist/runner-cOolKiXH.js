import { J as logVerbose, Z as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-DNjXI6xf.js";
import { E as runExec } from "./agent-scope-DcKzlxc-.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-C8bqH1yt.js";
import { t as normalizeChatType } from "./chat-type-CH3W-zKy.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-D3E0ptta.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-Y4aFpi2A.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-_0vi_hl_.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-D07WQyiR.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CGFENWmz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CSuEAlsd.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BzJ5LI6h.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-j5tVLINv.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-98vcL_Bk.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
...
function resolveImageModelFromAgentDefaults(cfg) {
	...
	if (typeof imageModel === "string") {
		if (imageModel.trim()) refs.push(imageModel.trim());
	} else {
		if (imageModel.primary?.trim()) refs.push(imageModel.primary.trim());
		for (const fb of imageModel.fallbacks ?? []) if (fb?.trim()) refs.push(fb.trim());
	}
	const entries = [];
