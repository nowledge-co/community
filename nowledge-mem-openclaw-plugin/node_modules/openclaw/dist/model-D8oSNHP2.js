...
import { Kt as DEFAULT_CONTEXT_TOKENS, Lt as resolveOpenClawAgentDir, l as normalizeProviderId } from "./model-selection-jLPRV2hp.js";
...
const ANTIGRAVITY_GEMINI_31_PRO_HIGH_TEMPLATE_MODEL_IDS = ["gemini-3-pro-high"];
const ANTIGRAVITY_GEMINI_31_PRO_LOW_TEMPLATE_MODEL_IDS = ["gemini-3-pro-low"];
...
function resolveAntigravityGemini31ForwardCompatModel(provider, modelId, modelRegistry) {
	const normalizedProvider = normalizeProviderId(provider);
	if (normalizedProvider !== "google-antigravity") return;
	const trimmedModelId = modelId.trim();
	const lower = trimmedModelId.toLowerCase();
	const isGemini31High = lower === ANTIGRAVITY_GEMINI_31_PRO_HIGH_MODEL_ID || lower === ANTIGRAVITY_GEMINI_31_PRO_DOT_HIGH_MODEL_ID;
	if (!isGemini31High && !(lower === ANTIGRAVITY_GEMINI_31_PRO_LOW_MODEL_ID || lower === ANTIGRAVITY_GEMINI_31_PRO_DOT_LOW_MODEL_ID)) return;
	return cloneFirstTemplateModel({
		normalizedProvider,
		trimmedModelId,
		templateIds: isGemini31High ? [...ANTIGRAVITY_GEMINI_31_PRO_HIGH_TEMPLATE_MODEL_IDS] : [...ANTIGRAVITY_GEMINI_31_PRO_LOW_TEMPLATE_MODEL_IDS],
		modelRegistry
	});
}
...
//#endregion
export { resolveForwardCompatModel as a, ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES as i, resolveModel as n, buildModelAliasLines as o, ANTIGRAVITY_GEMINI_31_FORWARD_COMPAT_CANDIDATES as r, model_exports as t };