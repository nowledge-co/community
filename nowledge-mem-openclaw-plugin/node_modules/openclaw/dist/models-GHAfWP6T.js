...
import { Ct as resolveApiKeyForProvider, E as resolveOpenClawAgentDir, G as resolveModelRefFromString, Gt as DEFAULT_PROVIDER, H as resolveConfiguredModelRef, I as modelKey, Kt as resolveAuthProfileDisplayLabel, M as buildModelAliasIndex, N as findNormalizedProviderValue, Pt as shouldEnableShellEnvFallback, R as normalizeProviderId, T as resolveAuthStorePathForDisplay, Tt as resolveEnvApiKey, U as resolveDefaultModelForAgent, Wt as DEFAULT_MODEL, g as listProfilesForProvider, kt as getShellEnvAppliedKeys, n as resolveAuthProfileOrder, s as resolveProfileUnusableUntilForDisplay, v as setAuthProfileOrder, wt as resolveAwsSdkEnvVarName, x as ensureAuthProfileStore, xt as getCustomProviderApiKey, y as upsertAuthProfile, z as parseModelRef } from "./auth-profiles-B5C565zk.js";
import { t as formatCliCommand } from "./command-format-_PO7rvrJ.js";
import { D as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelFallbacksOverride, c as resolveAgentWorkspaceDir, i as resolveAgentDir, l as resolveDefaultAgentId, o as resolveAgentModelPrimary } from "./agent-scope-Vp6cG_dU.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-JLvgsKfX.js";
import { a as resolveForwardCompatModel, i as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES, r as ANTIGRAVITY_GEMINI_31_FORWARD_COMPAT_CANDIDATES } from "./model-Dckbsy27.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { C as parseDurationMs, i as loadConfig } from "./config-T-YRaqlE.js";
import { _n as maskApiKey, _t as describeFailoverError, an as formatUsageWindowSummary, bn as formatRemainingShort, on as resolveUsageProviderId, rn as loadProviderUsageSummary, s as runEmbeddedPiAgent, vn as DEFAULT_OAUTH_WARN_MS, yn as buildAuthHealthSummary } from "./subagent-registry-C8AjcLWJ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CXIOqFsA.js";
import { t as ensureOpenClawModelsJson } from "./models-config-TLdOHH0m.js";
import { n as loadModelCatalog } from "./model-catalog-Dw64TluO.js";
import { r as withProgressTotals } from "./progress-GGN1XdxY.js";
...
import { t as createClackPrompter } from "./clack-prompter-WNNLlfYu.js";
import { t as renderTable } from "./table-muj3Scnd.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-oligHsSJ.js";
import { n as redactSecrets } from "./format-DD_JpuRD.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-FeUGvfHN.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BjXE62L_.js";
import { n as logConfigUpdated } from "./logging-COSqTUXs.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BgsX_d0R.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-T-YRaqlE.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-B5C565zk.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-Dckbsy27.js").then((n) => n.t);
