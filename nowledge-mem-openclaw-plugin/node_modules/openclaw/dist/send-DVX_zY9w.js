...
import { ht as danger, r as isTruthyEnvValue, s as createSubsystemLogger, yt as logVerbose } from "./entry.js";
import { i as loadConfig, vt as resolveTelegramPreviewStreamMode } from "./config-T-YRaqlE.js";
import { u as resolveTelegramAccount } from "./plugins-mjKPZoHW.js";
import { h as normalizeMimeType, p as isGifMedia, u as getFileExtension, v as mediaKindFromMime } from "./image-ops-ED4c3lgi.js";
import { n as redactSensitiveText } from "./redact-iUwTNBtX.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-C0_m8FH_.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-De1DeW9v.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-S27Fz0Oh.js";
import { t as renderMarkdownWithMarkers } from "./render-kJVmJTwh.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CynYTGfO.js";
import { t as resolveFetch } from "./fetch-_VotajCU.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-DdH9i1uh.js";
import { n as normalizePollInput } from "./polls-C5zCULbA.js";
import { n as isWSL2Sync } from "./wsl-DioJd74d.js";
import { t as makeProxyFetch } from "./proxy-GwQeAgiZ.js";
...
//#endregion
export { extractTelegramLocation as A, normalizeAllowFromWithStore as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, formatLocationText as G, firstDefined as H, resolveTelegramReplyId as I, parseTelegramTarget as J, toLocationContext as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, isSenderIdAllowed as U, resolveSenderAllowMatch as V, mergeAllowFromSources as W, resolveTelegramTargetChatType as Y, resolveTelegramFetch as _, reactMessageTelegram as a, buildGroupLabel as b, sendStickerTelegram as c, wasSentByBot as d, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, hasBotMention as j, expandTextLinks as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, sendMessageTelegram as o, markdownToTelegramChunks as p, isVoiceCompatibleAudio as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, isSenderAllowed as z };