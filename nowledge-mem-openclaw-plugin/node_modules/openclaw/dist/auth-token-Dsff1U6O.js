...
import { At as upsertAuthProfile, B as SYNTHETIC_DEFAULT_MODEL_REF, C as XIAOMI_DEFAULT_MODEL_ID, E as buildXiaomiProvider, F as buildVeniceModelDefinition, H as buildSyntheticModelDefinition, I as TOGETHER_BASE_URL, L as TOGETHER_MODEL_CATALOG, Lt as resolveOpenClawAgentDir, M as VENICE_BASE_URL, N as VENICE_DEFAULT_MODEL_REF, P as VENICE_MODEL_CATALOG, R as buildTogetherModelDefinition, S as QIANFAN_DEFAULT_MODEL_ID, T as buildQianfanProvider, V as SYNTHETIC_MODEL_CATALOG, at as HUGGINGFACE_MODEL_CATALOG, dt as resolveCloudflareAiGatewayBaseUrl, it as HUGGINGFACE_BASE_URL, l as normalizeProviderId, lt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, ot as buildHuggingfaceModelDefinition, ut as buildCloudflareAiGatewayModelDefinition, w as buildKimiCodingProvider, x as QIANFAN_BASE_URL, z as SYNTHETIC_BASE_URL } from "./model-selection-jLPRV2hp.js";
...
//#endregion
export { setCloudflareAiGatewayConfig as $, applyVeniceConfig as A, applyCloudflareAiGatewayConfig as B, applyOpenrouterProviderConfig as C, ZAI_CN_BASE_URL as Ct, applySyntheticProviderConfig as D, applySyntheticConfig as E, ZAI_GLOBAL_BASE_URL as Et, applyXiaomiProviderConfig as F, HUGGINGFACE_DEFAULT_MODEL_REF as G, applyVercelAiGatewayConfig as H, applyZaiConfig as I, TOGETHER_DEFAULT_MODEL_REF as J, LITELLM_DEFAULT_MODEL_REF as K, applyZaiProviderConfig as L, applyXaiConfig as M, applyXaiProviderConfig as N, applyTogetherConfig as O, applyXiaomiConfig as P, setAnthropicApiKey as Q, applyLitellmConfig as R, applyOpenrouterConfig as S, XAI_DEFAULT_MODEL_REF as St, applyQianfanProviderConfig as T, ZAI_CODING_GLOBAL_BASE_URL as Tt, applyVercelAiGatewayProviderConfig as U, applyCloudflareAiGatewayProviderConfig as V, applyAgentDefaultModelPrimary as W, XIAOMI_DEFAULT_MODEL_REF as X, VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF as Y, ZAI_DEFAULT_MODEL_REF as Z, applyMistralProviderConfig as _, writeOAuthCredentials as _t, applyMinimaxApiConfig as a, setMistralApiKey as at, applyMoonshotProviderConfig as b, MOONSHOT_DEFAULT_MODEL_REF as bt, applyMinimaxApiProviderConfigCn as c, setOpenrouterApiKey as ct, applyAuthProfileConfig as d, setTogetherApiKey as dt, setGeminiApiKey as et, applyHuggingfaceConfig as f, setVeniceApiKey as ft, applyMistralConfig as g, setZaiApiKey as gt, applyKimiCodeProviderConfig as h, setXiaomiApiKey as ht, applyOpencodeZenProviderConfig as i, setMinimaxApiKey as it, applyVeniceProviderConfig as j, applyTogetherProviderConfig as k, applyMinimaxConfig as l, setQianfanApiKey as lt, applyKimiCodeConfig as m, setXaiApiKey as mt, validateAnthropicSetupToken as n, setKimiCodingApiKey as nt, applyMinimaxApiConfigCn as o, setMoonshotApiKey as ot, applyHuggingfaceProviderConfig as p, setVercelAiGatewayApiKey as pt, OPENROUTER_DEFAULT_MODEL_REF as q, applyOpencodeZenConfig as r, setLitellmApiKey as rt, applyMinimaxApiProviderConfig as s, setOpencodeZenApiKey as st, buildTokenProfileId as t, setHuggingfaceApiKey as tt, applyMinimaxProviderConfig as u, setSyntheticApiKey as ut, applyMoonshotConfig as v, KIMI_CODING_MODEL_REF as vt, applyQianfanConfig as w, ZAI_CODING_CN_BASE_URL as wt, applyMoonshotProviderConfigCn as x, QIANFAN_DEFAULT_MODEL_REF as xt, applyMoonshotConfigCn as y, MISTRAL_DEFAULT_MODEL_REF as yt, applyLitellmProviderConfig as z };