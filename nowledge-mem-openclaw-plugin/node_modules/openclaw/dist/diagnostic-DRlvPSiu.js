...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-DLuYVc4W.js";
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-Bm3NT0Ar.js").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
