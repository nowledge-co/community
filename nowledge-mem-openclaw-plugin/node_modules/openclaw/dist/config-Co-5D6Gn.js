import { c as expandHomePrefix, n as resolveConfigPath, r as resolveDefaultConfigCandidates, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-CyR9Pa1R.js";
import { A as isRecord, F as resolveConfigDir, G as isPlainObject$1, L as resolveUserPath, f as normalizeChatChannelId, s as CHANNEL_IDS } from "./subsystem-NZzGD1xL.js";
import { s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-CsUx6Yfs.js";
import { c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-DGv_lb5V.js";
import { $ as resolveShellEnvFallbackTimeoutMs, K as DEFAULT_CONTEXT_TOKENS, M as parseModelRef, Q as loadShellEnvFallback, et as shouldDeferShellEnvFallback, it as normalizeEnvVarKey, j as normalizeProviderId, nt as isDangerousHostEnvOverrideVarName, rt as isDangerousHostEnvVarName, tt as shouldEnableShellEnvFallback } from "./model-auth-D7yExN0T.js";
import { c as resolveMemorySlotDecision, l as isPathInside, o as normalizePluginsConfig, s as resolveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-CBHbnE_M.js";
...
//#endregion
export { isSafeExecutableValue as $, setConfigValueAtPath as A, buildSafeBinsShellCommand as B, validateJsonSchemaValue as C, unsetConfigOverride as D, setConfigOverride as E, SAFE_BIN_PROFILES as F, matchAllowlist as G, isWindowsPlatform as H, normalizeSafeBinProfileFixtures as I, extractShellWrapperInlineCommand as J, resolveAllowlistCandidatePath as K, resolveSafeBinProfiles as L, getTrustedSafeBinDirs as M, isTrustedSafeBinPath as N, getConfigValueAtPath as O, normalizeTrustedSafeBinDirs as P, splitShellArgs as Q, validateSafeBinArgv as R, isSupportedLocalAvatarExtension as S, resetConfigOverrides as T, splitCommandChain as U, buildSafeShellCommand as V, DEFAULT_SAFE_BINS as W, isShellWrapperExecutable as X, isDispatchWrapperExecutable as Y, unwrapKnownDispatchWrapperInvocation as Z, parseDurationMs as _, writeConfigFile as a, DEFAULT_SUBAGENT_MAX_SPAWN_DEPTH as at, isAvatarHttpUrl as b, TELEGRAM_COMMAND_NAME_PATTERN as c, resolveOwnerDisplaySetting as ct, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as d, mapStreamingModeToSlackLegacyDraftStreamMode as et, isInboundPathAllowed as f, normalizeScpRemoteHost as g, resolveIMessageRemoteAttachmentRoots as h, resolveConfigSnapshotHash as i, resolveTelegramPreviewStreamMode as it, unsetConfigValueAtPath as j, parseConfigPath as k, normalizeTelegramCommandName as l, resolveIMessageAttachmentRoots as m, loadConfig as n, resolveSlackNativeStreaming as nt, validateConfigObjectWithPlugins as o, resolveAgentMaxConcurrent as ot, mergeInboundPathRoots as p, resolveCommandResolutionFromArgv as q, readConfigFileSnapshot as r, resolveSlackStreamingMode as rt, parseByteSize as s, VERSION as st, createConfigIO as t, resolveDiscordPreviewStreamMode as tt, resolveTelegramCustomCommands as u, AVATAR_MAX_BYTES as v, getConfigOverrides as w, isPathWithinRoot as x, isAvatarDataUrl as y, analyzeShellCommand as z };