...
import { B as theme, k as info, l as escapeRegExp, z as isRich } from "./utils-DCtXtPui.js";
import { Ft as resolveHeartbeatDeliveryTarget, Hn as resolveUserTimezone, It as resolveHeartbeatSenderContext, Tr as peekSystemEventEntries, cr as CommandLane, dr as isHeartbeatContentEffectivelyEmpty, fr as resolveHeartbeatPrompt$1, ft as requestHeartbeatNow, lr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, mt as resolveHeartbeatReasonKind, pr as stripHeartbeatToken, pt as setHeartbeatWakeHandler, r as appendCronStyleCurrentTimeLine, rr as getQueueSize, t as getReplyFromConfig, ur as DEFAULT_HEARTBEAT_EVERY } from "./reply-IQbtp7d2.js";
import { f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CYc2uK4P.js";
import { l as resolveAgentIdFromSessionKey, p as toAgentStoreSessionKey, s as normalizeAgentId } from "./session-key-D7AdMgCp.js";
import { c as resolveAgentWorkspaceDir, g as DEFAULT_HEARTBEAT_FILENAME, l as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-CJ4YDowp.js";
import { t as isTruthyEnvValue } from "./env-Bi5nSj2_.js";
import { C as parseDurationMs, i as loadConfig } from "./config-D9td3nQ8.js";
import { i as hasErrnoCode, n as formatErrorMessage } from "./errors-botak1wn.js";
import { H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey, f as updateSessionStore, s as loadSessionStore, u as saveSessionStore } from "./sessions-CX6bjL0O.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-D_vAsEMg.js";
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-BycbLu-x.js";
import { l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CIwUV7XC.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-DpHv7nsB.js";
import { t as deliverOutboundPayloads } from "./deliver-GkW9X1sl.js";
import { o as resolveEffectiveMessagesConfig } from "./reply-prefix-BHd-zlJx.js";
...
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as resolveHeartbeatReplyPayload, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-BZgmGA8X.js";
...
async function runHeartbeatOnce(opts) {
	...
	const pendingEvents = preflight.shouldInspectPendingEvents ? pendingEventEntries.map((event) => event.text) : [];
	const cronEvents = pendingEventEntries.filter((event) => (isCronEventReason || event.contextKey?.startsWith("cron:")) && isCronSystemEvent(event.text)).map((event) => event.text);
