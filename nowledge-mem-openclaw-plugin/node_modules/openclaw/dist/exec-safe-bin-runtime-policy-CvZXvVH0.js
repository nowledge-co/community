import { H as getTrustedSafeBinDirs, K as normalizeSafeBinProfileFixtures, W as normalizeTrustedSafeBinDirs, q as resolveSafeBinProfiles } from "./config-T-YRaqlE.js";
import { i as resolveSafeBins } from "./exec-approvals-allowlist-DEK2b59y.js";
...
function resolveExecSafeBinRuntimePolicy(params) {
	...
	return {
		safeBins,
		safeBinProfiles,
		trustedSafeBinDirs: getTrustedSafeBinDirs({ extraDirs: [...normalizeTrustedSafeBinDirs(params.global?.safeBinTrustedDirs), ...normalizeTrustedSafeBinDirs(params.local?.safeBinTrustedDirs)] }),
		unprofiledSafeBins,
